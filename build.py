...
<header class="site-header">
  ...
  <div class="header-top">
    <div class="header-inner">
      ...
      <p class="header-tagline"><span class="tag-gem">◆</span> 김포시 전지역 방문 관리 <span class="tag-gem">◆</span> 24시간 상담</p>
  ...
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <address class="footer-contact">
        ...
        <span class="footer-contact-row"><span class="footer-label">서비스 지역</span> 경기도 김포시 전지역</span>
      </address>
    </div>
